...
<p>If you want to maximize the performance of developing and coding, please read &quot;<a href="https://1des.com/blog/posts/improve-algorithmic-trading-win-rate-machine-learning-labelling-data" target="_blank">How to Enhance Algo Trading Win Rate with ML: Labelling Data</a>&quot; before proceeding.</p>
...
<p><img alt="Binance OHLC data" src="https://1des.com/uploads/posts/improve-algorithmic/feature-selection/binance-data.jpg" style="height:295px; width:512px" /></p>
...
<p><img alt="Histogram of Close" src="https://1des.com/uploads/posts/improve-algorithmic/feature-selection/fig-1.jpg" style="height:382px; width:452px" /></p>
...
<p>In addition to a normal distribution, we need to consider whether our new features are aligned with our strategy. For example, let&rsquo;s see if the difference between SMA9 and SMA20 (Our rule for labeling the data in the strategic algorithm) can be a good feature for the machine or not.</p>

<p><img alt="Histogram diff SMA 9-20" src="https://1des.com/uploads/posts/improve-algorithmic/feature-selection/fig-2.jpg" style="height:344px; width:432px" /></p>

<p>Well, the distribution here is closer to normal, but there is still one more problem to fix. You can see that our feature range stands between -1500 and 1500. By having such a wide range of values in a feature, the model will misinterpret the data while training and generate useless results. So we divide the &ldquo;SMA9 - SMA20&rdquo; by SMA20 to reach a range between -1 and 1.</p>

<p><img alt="Histogram diff SMA/sma20" src="https://1des.com/uploads/posts/improve-algorithmic/feature-selection/fig-3.jpg" style="height:324px; width:428px" /></p>

<p>In our experience, diff_sma9_sma20 is now a valuable feature, but if we feed only that, we cannot expect much improvement in the model compared to our algorithm. Therefore, we built some features so that the model can better understand the characteristics of our labeling algorithm. For that, we copy our dataset columns, calculate our new features, and then remove the useless columns for further steps. Building features on this step is based on these rules:</p>
...
<p><img alt="code" src="https://1des.com/uploads/posts/improve-algorithmic/feature-selection/fig-4.jpg" style="height:359px; width:512px" /></p>
...
<p><img alt="Heatmap plot" src="https://1des.com/uploads/posts/improve-algorithmic/feature-selection/fig-5.jpg" style="height:381px; width:465px" /></p>
