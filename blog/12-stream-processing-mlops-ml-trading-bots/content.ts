...
<div class="prose prose-invert max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-100">
  ...
  <h2 class="text-2xl font-bold mt-8">What is Stream Processing?</h2>
  ...
  <div class="my-8">
    <img src="/posts/12/stream-processing-6.jpg" alt="stream-processing" class="w-full h-auto rounded-xl shadow-md" />
  </div>

  <h2 class="text-2xl font-bold mt-8">Why is Stream Processing Important for ML-Based Trading Bots?</h2>
  ...
  <div class="my-8">
    <img src="/posts/12/stream-processing-6.png" alt="stream-processing" class="w-full h-auto rounded-xl shadow-md" />
  </div>

  <h2 class="text-2xl font-bold mt-8">How Does Stream Processing Support MLOps for Trading Bots?</h2>
  ...
  <div class="my-8">
    <img src="/posts/12/stream-processing-2.jpg" alt="stream-processing" class="w-full h-auto rounded-xl shadow-md" />
  </div>

  <h2 class="text-2xl font-bold mt-8">Stream Processing with Faust in Python</h2>
  ...
  <div class="my-8">
    <img src="/posts/12/stream-processing-4.jpg" alt="stream-processing" class="w-full h-auto rounded-xl shadow-md" />
  </div>
  ...
  <div class="my-8">
    <img src="/posts/12/stream-processing-5.jpg" alt="stream-processing" class="w-full h-auto rounded-xl shadow-md" />
  </div>
  ...
  <div class="my-8">
    <img src="/posts/12/stream-processing-3.jpg" alt="stream-processing" class="w-full h-auto rounded-xl shadow-md" />
  </div>
